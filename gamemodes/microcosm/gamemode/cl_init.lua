...
hook.easy("PreDrawHUD",function()
	...
	if LocalPlayer():Team()==5 then
		...
		draw.SimpleText("Welcome to the playtest!","micro_big",ScrW()/2,ScrH()-125,Color(255,0,255),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("Press F2 or type /team to join a team.","micro_med",ScrW()/2,ScrH()-60,Color(255,255,255),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
